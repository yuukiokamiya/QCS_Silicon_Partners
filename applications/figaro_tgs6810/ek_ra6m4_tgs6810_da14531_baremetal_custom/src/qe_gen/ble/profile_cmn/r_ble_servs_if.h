 ...
 ***********************************************************************************************************************/
typedef void (*ble_servs_attr_write_req_t)(const void *p_attr,
		uint16_t conn_hdl, ble_status_t result, const void *p_app_value);
 ...
 ***********************************************************************************************************************/
typedef void (*ble_servs_attr_write_cmd_t)(const void *p_attr,
		uint16_t conn_hdl, ble_status_t result, const void *p_app_value);
 ...
 ***********************************************************************************************************************/
typedef void (*ble_servs_attr_write_comp_t)(const void *p_attr,
		uint16_t conn_hdl, ble_status_t result, const void *p_app_value);
 ...
 * @param[in]   conn_hdl Connection handle.
 ***********************************************************************************************************************/
typedef void (*ble_servs_attr_read_req_t)(const void *p_attr,
		uint16_t conn_hdl);
 ...
 * @param[in]   conn_hdl Connection handle.
 ***********************************************************************************************************************/
typedef void (*ble_servs_attr_hdl_val_cnf_t)(const void *p_attr,
		uint16_t conn_hdl);
 ...
 ***********************************************************************************************************************/
typedef void (*ble_servs_app_cb_t)(uint16_t type, ble_status_t result,
 ...
 ***********************************************************************************************************************/
typedef ble_status_t (*ble_servs_attr_decode_t)(void *p_app_value,
 ...
 ***********************************************************************************************************************/
typedef ble_status_t (*ble_servs_attr_encode_t)(const void *p_app_value,
