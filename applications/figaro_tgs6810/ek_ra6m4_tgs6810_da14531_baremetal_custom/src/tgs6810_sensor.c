...
void g_tgs6810_quick_setup(void)
{
    fsp_err_t err;

    err = g_tgs6810_sensor0.p_api->open(g_tgs6810_sensor0.p_ctrl, g_tgs6810_sensor0.p_cfg);
    assert(FSP_SUCCESS == err);
}

/* Quick getting tgs6810 data*/
void g_tgs6810_sensor0_read(float *p_temperature, float *p_humidity, float *p_gas)
{
    fsp_err_t err;
    rm_tgs6810_data_t p_data;
