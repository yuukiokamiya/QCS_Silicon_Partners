 ...
 *******************************************************************************/
typedef enum {
	BLE_GATS_SERV_CHGED_IDX, BLE_GATS_SERV_CHGED_CLI_CNFG_IDX,
...
typedef enum {
	/* Service Changed */
	BLE_GATS_EVENT_SERV_CHGED_HDL_VAL_CNF = BLE_SERVS_ATTR_EVENT(
			BLE_GATS_SERV_CHGED_IDX, BLE_SERVS_HDL_VAL_CNF),
} e_ble_gats_event_t;
