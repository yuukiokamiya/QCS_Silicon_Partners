...
typedef enum {
	/* Device Name */
	BLE_GAPC_EVENT_DEV_NAME_READ_RSP = BLE_SERVC_ATTR_EVENT(
			BLE_GAPC_DEV_NAME_IDX, BLE_SERVC_READ_RSP),
	BLE_GAPC_EVENT_DEV_NAME_WRITE_RSP = BLE_SERVC_ATTR_EVENT(
			BLE_GAPC_DEV_NAME_IDX, BLE_SERVC_WRITE_RSP),
	/* Appearance */
	BLE_GAPC_EVENT_APPEARANCE_READ_RSP = BLE_SERVC_ATTR_EVENT(
			BLE_GAPC_APPEARANCE_IDX, BLE_SERVC_READ_RSP),
	/* Peripheral Preferred Connection Parameters */
	BLE_GAPC_EVENT_PER_PREF_CONN_PARAM_READ_RSP = BLE_SERVC_ATTR_EVENT(
			BLE_GAPC_PER_PREF_CONN_PARAM_IDX, BLE_SERVC_READ_RSP),
	/* Central Address Resolution */
	BLE_GAPC_EVENT_CENT_ADDR_RSLV_READ_RSP = BLE_SERVC_ATTR_EVENT(
			BLE_GAPC_CENT_ADDR_RSLV_IDX, BLE_SERVC_READ_RSP),
	/* Resolvable Private Address Only */
	BLE_GAPC_EVENT_RSLV_PRIV_ADDR_ONLY_READ_RSP = BLE_SERVC_ATTR_EVENT(
			BLE_GAPC_RSLV_PRIV_ADDR_ONLY_IDX, BLE_SERVC_READ_RSP),
} e_ble_gapc_event_t;
