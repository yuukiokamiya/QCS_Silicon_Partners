...
typedef enum {
	/* Device Name */
	BLE_GAPS_EVENT_DEV_NAME_WRITE_REQ = BLE_SERVS_ATTR_EVENT(
			BLE_GAPS_DEV_NAME_IDX, BLE_SERVS_WRITE_REQ),
	BLE_GAPS_EVENT_DEV_NAME_WRITE_COMP = BLE_SERVS_ATTR_EVENT(
			BLE_GAPS_DEV_NAME_IDX, BLE_SERVS_WRITE_COMP),
	BLE_GAPS_EVENT_DEV_NAME_READ_REQ = BLE_SERVS_ATTR_EVENT(
			BLE_GAPS_DEV_NAME_IDX, BLE_SERVS_READ_REQ),
	/* Appearance */
	BLE_GAPS_EVENT_APPEARANCE_READ_REQ = BLE_SERVS_ATTR_EVENT(
			BLE_GAPS_APPEARANCE_IDX, BLE_SERVS_READ_REQ),
	/* Peripheral Preferred Connection Parameters */
	BLE_GAPS_EVENT_PER_PREF_CONN_PARAM_READ_REQ = BLE_SERVS_ATTR_EVENT(
			BLE_GAPS_PER_PREF_CONN_PARAM_IDX, BLE_SERVS_READ_REQ),
	/* Central Address Resolution */
	BLE_GAPS_EVENT_CENT_ADDR_RSLV_READ_REQ = BLE_SERVS_ATTR_EVENT(
			BLE_GAPS_CENT_ADDR_RSLV_IDX, BLE_SERVS_READ_REQ),
	/* Resolvable Private Address Only */
	BLE_GAPS_EVENT_RSLV_PRIV_ADDR_ONLY_READ_REQ = BLE_SERVS_ATTR_EVENT(
			BLE_GAPS_RSLV_PRIV_ADDR_ONLY_IDX, BLE_SERVS_READ_REQ),
} e_ble_gaps_event_t;
