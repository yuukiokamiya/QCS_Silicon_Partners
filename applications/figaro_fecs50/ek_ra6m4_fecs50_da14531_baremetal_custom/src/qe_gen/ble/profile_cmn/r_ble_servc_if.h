 ...
 ***********************************************************************************************************************/
typedef void (*ble_servc_attr_write_rsp_t)(const void *p_attr,
		uint16_t conn_hdl, ble_status_t result);
 ...
 ***********************************************************************************************************************/
typedef void (*ble_servc_attr_read_rsp_t)(const void *p_attr, uint16_t conn_hdl,
 ...
 ***********************************************************************************************************************/
typedef void (*ble_servc_attr_hdl_val_ntf_t)(const void *p_attr,
 ...
 ***********************************************************************************************************************/
typedef void (*ble_servc_attr_hdl_val_ind_t)(const void *p_attr,
		uint16_t conn_hdl, const void *p_app_value);
 ...
 ***********************************************************************************************************************/
typedef void (*ble_servc_app_cb_t)(uint16_t type, ble_status_t result,
 ...
 ***********************************************************************************************************************/
typedef ble_status_t (*ble_servc_attr_decode_t)(void *p_app_value,
 ...
 ***********************************************************************************************************************/
typedef ble_status_t (*ble_servc_attr_encode_t)(const void *p_app_value,
